...
<div class="topbar-divider d-none d-sm-block"></div>
      ...
      <form action="productfetch.php" method="post" enctype="multipart/form-data" style="color:black;">
        ...
        <p><input type="text" name="tensp"></p>
        <p class="pp">Tác giả:</p>
        <p><input type="text" name="tacgia"></p>
        <p>Thể loại:
          <select name="theloai">
        ...
        <table>
          ...
          <th>
            <p>Đặt giá:</p>
            <p><input type="text" name="giaban"></p>
          </th>
          <th>
            <p style="margin-left:15px;">Giá khấu trừ:</p>
            <p style="margin-left:15px;"><input type="text" name="giakhautru"></p>
          </th>
          </tr>
          <tr>
          <th>
            <p>Giá Gốc:</p>
            <p><input type="text" name="giagoc"></p>
