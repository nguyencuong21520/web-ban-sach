  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Các đơn hàng cần xử lý:</h1>
          <a href="confirmbilldone.php" class="btn btn-info"  style="width:20%;margin-top:10px;">Các đơn hàng đã xử lý</a>
    ...
    <tbody>
      ...
      if(isset($_GET['var']) && ($_GET['var']) !='')
      {
        ...
        FROM hoadon,khachhang  where  khachhang.id=hoadon.idkh and khachhang.hoten like "%'.$_GET['var'].'%" and hoadon.tinhtrang="Chưa giao"';
      }
      else
      {
        $sel="SELECT hoadon.id, khachhang.hoten, hoadon.ngayhd, hoadon.tongtien, hoadon.hinhthuc, hoadon.tinhtrang FROM hoadon,khachhang  where  khachhang.id=hoadon.idkh and hoadon.tinhtrang='Chưa giao'";
      }
    ...
    ?>
      <tr>
          ...
          <td><?php echo $row['tinhtrang']; ?></td>   
           <td><a onclick="return confirm('Bạn chắc chứ?')" href="deletebill.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Hủy</a></td>
           <td><a onclick="return confirm('Bạn chắc chứ?')" href="confirmbill.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Xác nhận</a></td>
