...
<body id="page-top">
  ...
  <p>
    ...
    <tbody>
      ...
      {
        $sel = 'select * from sanpham where tensp like "%'.$_GET['var'].'%"';
      }
      else
      {
        $sel = 'select * from sanpham';
      }
      $ms=$con->query($sel);
    ...
    ?>
      <tr>
          ...
          <td> <img src="pimages/<?php echo $row['anh']; ?>" style="width:80px;"></td>
          <td><?php echo $row['tensp']; ?></td>
          <td><?php echo $row['tacgia']; ?></td>
          <td><?php echo $row['theloai']; ?></td>
          <td><?php echo $row['mota']; ?></td>
          <td><?php echo $row['giaban']; ?></td>
          <td><?php echo $row['giakhautru']; ?></td>
