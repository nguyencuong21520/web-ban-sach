  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <form action="updatefetch.php" method="post" enctype="multipart/form-data" style="color:black;">
        ...
        <p><input type="text" name="tensp" value="<?php echo $row['tensp']; ?>"></p>
        <p class="pp">Tác giả:</p>
        <p><input type="text" name="tacgia" value="<?php echo $row['tacgia']; ?>"></p>
        <p>Thể loại:
          <select name="theloai">
        ...
        <p>Miêu tả:</p>
        <textarea name="mota" value="<?php echo $row['mota'];?>"><?php echo $row['mota'];?></textarea>
        <br>
        <div>
          <p>Cập nhật hình ảnh:</p>
          <input type="file" name="anh">
          <p><img src="pimages/<?php echo $row['anh']; ?>" style="width:200px;height:200px;"></p>
        </div>
        <br>
        <hr>
        <table>
          ...
          <th>
            <p>Đặt giá:</p>
            <p><input type="text" name="giaban" value="<?php echo $row['giaban']; ?>"></p>
          </th>
          <th>
            <p style="margin-left:15px;">Giá khâu trừ:</p>
            <p style="margin-left:15px;"><input type="text" name="giakhautru" value="<?php echo $row['giakhautru']; ?>"></p>
          </th>
          </tr>
          <tr>
          <th>
            <p>Giá gốc:</p>
            <p><input type="text" name="giagoc" value="<?php echo $row['giagoc']; ?>"></p>
