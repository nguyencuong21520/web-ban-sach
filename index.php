...
<figure class="col-md-2 ot">
  <div class="card" style="width:210px;" onclick="myFunction()">
    <a href=""><img class="card-img-top" src="admin/pimages/<?php echo $row['anh']; ?>" alt="Card image" style="width:100%;height:260px"></a>
    <div class="card-body">
      <h4 class="card-title"><?php echo $row['tensp']; ?></h4>
      <p class="card-text"><?php echo $row['giaban']; ?> Đồng VN</p>
...
if(isset($_GET['var']) && ($_GET['var']) !='')
{
  $sel = 'select * from sanpham where title like "%'.$_GET['var'].'%" and theloai like "Kinh dị"';
}
else
{
...
if(isset($_GET['var']) && ($_GET['var']) !='')
{
  $sel = 'select * from sanpham where title like "%'.$_GET['var'].'%" and theloai like "Truyện tranh"';
}
else
{
...
if(isset($_GET['var']) && ($_GET['var']) !='')
{
  $sel = 'select * from sanpham where title like "%'.$_GET['var'].'%" and theloai like "Giáo dục"';
}
else
{
...
if(isset($_GET['var']) && ($_GET['var']) !='')
{
  $sel = 'select * from sanpham where title like "%'.$_GET['var'].'%" and theloai like "Trẻ em"';
}
else
{
...
if(isset($_GET['var']) && ($_GET['var']) !='')
{
  $sel = 'select * from sanpham where title like "%'.$_GET['var'].'%" and theloai like "Sách văn học"';
}
else
{
