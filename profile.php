...
<section class="row">
 ...
 <?php
  ...
  $e=$_POST['userid'];
  $sel="SELECT * FROM khachhang where id='$e'";
  $rm=$con->query($sel);
...
<img src="admin/userimages/<?php echo $row['anhdaidien'];?>" style="width:200px;height:200px;border:2px solid black;border-radius:50%;float:left;box-shadow: 2px 2px 4px 4px #00ffff;margin-top:25px;"><br>
</figure>
<!--name input-->
<article class="col-md-3">
  <p style="margin-top: 30px;font-family:Comic Sans Ms;font-size:35px;">Tên:&nbsp<?php echo $row['hoten'] ?></p>
<!--phone no input-->
  <p style="margin-top: 5px;font-family:Comic Sans Ms;font-size:20px;"><i class='fas fa-phone-square-alt' style='font-size:24px;box-shadow: 2px 2px 4px 4px #ff0066;'></i>&nbsp<?php echo $row['sdt'] ?></p>
<!--email input-->
 ...
 <!--birthdate input-->
 <p style="margin-top: 5px;font-family:Comic Sans Ms;font-size:20px;">Ngày sinh:&nbsp<?php echo $row['ngaysinh'] ?></p>
 <!--gender input-->
 <p style="margin-top: 5px;font-family:Comic Sans Ms;font-size:20px;">Giới tính:&nbsp<?php echo $row['gioitinh'] ?></p>
 <!--Address input-->
 <p style="margin-top: 5px;font-family:Comic Sans Ms;font-size:20px;">Địa chỉ:&nbsp<?php echo $row['diachi'] ?></p>
