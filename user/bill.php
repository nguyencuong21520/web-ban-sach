...
<article class="col-md-12" style="margin-top: 30px;">
  <h3>Các hóa đơn đang xử lý:</h3>
</article>
...
<table style="margin-left:15px;margin-top:20px">
   <tr style="background-color:#66ffff;">
    ...
    <th style="padding-left:30px;">Hủy đơn</th>
  </tr>
  <?php       
              $con=mysqli_connect("localhost","root","","kitaab");
              $use=$_SESSION['userid'];
              $sel="SELECT * FROM hoadon where idkh='$use' and tinhtrang='Chưa giao'";
              $r=$con->query($sel);
  ...
  <tr>
    ...
    <th style="padding-left:20px;"><a onclick="return confirm('Bạn chắc chứ?')" href="deletebill.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" style="  background: linear-gradient(to bottom, #ff0066 0%, #66ffcc 100%);color:black;border:1px solid white;">Hủy đơn</a></th>
 </tr>
<?php } ?>
</tr>
<tr>
...
<form action="billfetch.php" method="post" enctype="multipart/form-data">
  ...
  <p>
                ...
                <a href="billdone.php" class="btn btn-info"  style="width:100%;margin-top:10px;">Xem lịch sử đơn hàng</a>
                <a href="cart.php" class="btn btn-info"  style="width:100%;margin-top:10px;">Xem giỏ hàng</a>
  </p>
