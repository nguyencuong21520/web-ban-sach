        ...
        <div class="card" style="width:210px;">
          <form action="addcartfetch.php" method="post" enctype="multipart/form-data">
            ...
            <a href="prdctview.php?id=<?php echo $row['id']; ?>"><img class="card-img-top"
                src="../admin/pimages/<?php  echo $row['image'];?>" alt="Card image"
            ...
            <div class="card-body">
              ...
              <p><input type="submit" name="sb" value="Thêm vào giỏ hàng" class="btn btn-danger"
                  style="width:100%;height:40px;margin-top:5px;"><a href="#"><button type="button" class="btn btn-info"
                    style="width:100%;height:40px;margin-top:5px;"><span style="font-size: 20px;">Mua
                      ngay</span></button></a></p>
    ...
    <figure class="col-md-2" style="margin:40px;">
      ...
      <div class="card" style="width:210px;">
        <form action="addcartfetch.php" method="post" enctype="multipart/form-data">
          ...
          <p><input type="hidden" value="../admin/pimages/<?php  echo $row['image'];?>" name="img"></p>
          <a href="prdctview.php?id=<?php echo $row['id']; ?>"><img class="card-img-top"
              src="../admin/pimages/<?php  echo $row['image'];?>" alt="Card image" style="width:100%;height:260px"></a>
          <div class="card-body">
            <p><input type="hidden" name="titl" value="<?php echo $row['title']?>"></p>
            <h4 class="card-title">
              <?php echo $row['title']; ?>
