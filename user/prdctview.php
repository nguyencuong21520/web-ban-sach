...
<!--product details-->
 ...
 <aside class="3">
    ...
    <img src="../admin/pimages/<?php  echo $row['anh'];?>" alt="Courts fool book cover page" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd" style="font-size: 23px;"><?php echo $row['tensp'];?></span></h2>
    <p>Tác giả: <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"><?php echo $row['tacgia']; ?></span></p>
    <hr>

    

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Giá Bán<br><?php echo $row['giaban']; ?> VN Đồng</p><br>
    ...
    <div id="pp"><?php echo $row['mota'];?></div>  
    <hr>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    ...
    <p style="margin-left:20px;">Giá bán <?php echo $row['giaban']; ?> VN đồng<br>
    
    Giảm gốc: <del> <?php echo $row['giagoc']; ?> VN đồng</del><br>
    Giám giá: <?php echo $row['giakhautru']; ?> VN đồng<br>
    
    <label for="quantity">Số lượng:</label>
    <input type="number"  name="soluong" value="1" style="width:20%" min="1" max="99">
  <hr>
  ...
  <p><input type="submit" name="ad" class="form-control" style="text-align:center;background-color:rgba(255, 204, 0)" value="Thêm vào giỏ hàng"><br>
    <!-- <button class="form-control" style="text-align:center;background-color:rgba(255, 102, 0,0.8)">Mua ngay</button> -->
    </p>
